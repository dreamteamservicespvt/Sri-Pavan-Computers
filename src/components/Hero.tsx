      ...
      <div className="relative z-20 h-full flex flex-col items-center justify-center text-white container mx-auto px-4">
        <div className={`max-w-3xl mx-auto text-center transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
            Sri Pavan <span className="text-accent">Computers</span>
          </h1>
          <p className="text-xl md:text-2xl mb-8 opacity-90 max-w-2xl mx-auto">
            Empowering your tech journey with premium IT products and expert-driven solutions you can trust.
          </p>
          
          <div className="flex flex-wrap justify-center gap-4 mt-8">
            <Button asChild size="lg" className="gap-2 bg-accent hover:bg-accent/90 text-white shadow-lg hover:shadow-accent/20 hover:shadow-xl transition-all">
              <Link to="/pc-builder">
                Build Your Dream PC
              </Link>
            </Button>
            
            <Button asChild variant="outline" size="lg" className="bg-white/10 backdrop-blur-sm border-white/40 gap-2 hover:bg-white/20 transition-all">
