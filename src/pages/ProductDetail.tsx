...
import { ArrowLeft, Star, ShieldCheck, Truck, RotateCw, PhoneCall } from 'lucide-react';
...
const getProductById = (id: string): ProductProps | undefined => {
  const products: ProductProps[] = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1597858520171-563a8e8b9925?q=80&w=2069",
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="md:w-1/2">
              ...
              {/* Price section - replaced with "Contact for pricing" */}
              <div className="mt-4">
                <h3 className="text-lg font-medium text-gray-900">Price</h3>
                <div className="flex items-center mt-2">
                  <span className="text-gray-600 italic">Contact us for current pricing information</span>
                </div>
              </div>
